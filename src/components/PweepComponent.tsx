...
import { calculateHowLongAgo } from "../utils/datetime";
    ...
    <div className="pweep">
      ...
      <div className="pweep__body">
        <div className="pweep__body-header">
          <div className="pweep__username">{user.username}</div>
          <div className="pweep__handle">@{user.handle}</div>
          <div className="pweep__creation-date">{calculateHowLongAgo(pweep.createdAt)}</div>
        </div>
